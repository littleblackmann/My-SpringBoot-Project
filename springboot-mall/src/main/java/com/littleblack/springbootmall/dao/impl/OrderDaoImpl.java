...
import com.littleblack.springbootmall.rowmapper.OrderItemRowMapper;
import com.littleblack.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public void createOrderItems(Integer orderId, List<OrderItem> orderItemsList) {
        ...
        // 使用 for loop 一條一條 sql 加入數據，這樣效率較低
